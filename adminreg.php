...
<div class="mwrap">    
    ...
    <h3>Registration</h3>
        ...
        <form method="post" enctype="multipart/form-data" id="ask">
             ...
             <div class="all"><label>Pix</label>
             <input type="file" name="file" id="phfile"  required="required">
             </div>
			...
			<div class="all"><label>Role</label>
            <select name="role" id="role">
             ...
             <div class="all"><label></label><button type="submit" id="adminreg">Add</button></div>
    </form>
